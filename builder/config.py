...
SOURCES = [
    Source(
        ...
        "ripestat_country",
        "RIPEstat country resource list (IPv4, IPv6, ASNs)",
    ),
    Source(
        "ipverse-rir-ipv4",
        "A",
    ...
    Source(
        "ipdeny-ipv6",
        "A",
        ["https://www.ipdeny.com/ipv6/ipaddresses/aggregated/ir-aggregated.zone"],
    ...
    Source(
        ...
        "dbip_csv",
        "DB-IP country lite (monthly CSV)",
    ),
    Source(
        "loyalsoldier-geoip",
        "B",
    ...
    Source(
        "ramtiiin",
        "D",
        [f"{_GH}/Ramtiiin/iran-ip/main/ip-list.rsc", f"{_JSD}/Ramtiiin/iran-ip@main/ip-list.rsc"],
